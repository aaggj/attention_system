...
int main(int argc, char **argv)
{
  ...
  auto attention_client_node = std::make_shared<gb_attention::AttentionClientNode>();

  attention_client_node->trigger_transition(lifecycle_msgs::msg::Transition::TRANSITION_CONFIGURE);
  rclcpp::spin_some(attention_client_node->get_node_base_interface());
  attention_client_node->trigger_transition(lifecycle_msgs::msg::Transition::TRANSITION_ACTIVATE);

  rclcpp::spin(attention_client_node->get_node_base_interface());
